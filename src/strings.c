...
const u8 gText_NotifyFaint[] = _("NOTIFY FAINT");
...
const u8 gText_NotifyFaintOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_NotifyFaintOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
